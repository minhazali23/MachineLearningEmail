...
public class GmailAuthenticatorService {
     ...
     * Used to get Credential of application
     */
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GmailAuthenticatorService.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public Gmail getGmailService() throws IOException, GeneralSecurityException {
        ...
        try {
            ...
            System.out.println("Problem when calling new Gmail service: " + ex);
        }
        return service;
    }
